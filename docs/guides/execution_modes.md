...
- **Prebuilt mode** — Kinetic pulls a published base image and installs
  your dependencies at pod startup.
...
accelerator runtime, then installs your project's dependencies at pod
startup.
