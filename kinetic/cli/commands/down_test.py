"""Tests for kinetic.cli.commands.down — destroy infrastructure."""
...
_BASE_PATCHES = {
  "check_all": mock.patch("kinetic.cli.commands.down.check_all"),
  "resolve_project": mock.patch(
    "kinetic.cli.commands.down.resolve_project",
    return_value="test-project",
  ),
  "apply_destroy": mock.patch(
    "kinetic.cli.commands.down.apply_destroy", return_value=True
  ),
}
